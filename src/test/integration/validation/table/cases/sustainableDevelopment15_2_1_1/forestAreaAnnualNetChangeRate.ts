...
const tableName = TableNames.sustainableDevelopment15_2_1_1
const colName = '2000-2010'
const variableName = 'forestAreaAnnualNetChangeRate'
...
export const forestAreaAnnualNetChangeRate: Array<TableValidationTestCase> = [
  ...
  // There is no minimum, so a forest loss reported as a negative rate is valid
  {
    cell,
    data: [datum('-1.5')],
    expected: undefined,
    name: `${ValidatorName.notGreaterThan}: negative rate is valid`,
  },
  {
    cell,
    data: [datum('0')],
    expected: undefined,
    name: `${ValidatorName.notGreaterThan}: zero rate is valid`,
  },
  {
    cell,
    data: [datum('50')],
