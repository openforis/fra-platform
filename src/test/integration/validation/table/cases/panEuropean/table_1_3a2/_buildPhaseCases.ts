...
const woodSupply = (phase: ColName, raw: string): NodeUpdate =>
  datum('forest_available_for_wood_supply_even_aged_stands_of_which_1990', phase, raw)
  ...
  messages: [
    {
      ...
      params: {
        parentCol: {
          key: `panEuropean.ageClassDistributionVolumeOfEvenAgedStandsInForestAvailableForWoodSupply.${phase}`,
        },
        parentTable: '1.3a2',
        parentVariable: {
