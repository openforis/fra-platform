module.exports = {
  ...
  nationalForestInventory: 'Inventario Forestal Nacional (IFN)',
  remoteSensingBasedAssessmentWithGroundTruthing:
    'Evaluación basada en mapas realizados mediante técnicas de teledetección con verificación sobre el terreno',
  statisticalRemoteSensingSurveyWithAccuracyAssessment:
    'Muestreo estadístico basado en imágenes de teledetección con medición de precisión',
