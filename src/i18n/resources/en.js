  ...
  panEuropean: {
    ...
    countryComments: {
      ...
      areaWithNumberOfTreeSpeciesOccurringOnForestAndOwl:
        'Area with number of tree species occurring on forest and owl',
      ...
      approachApplieToReportingOnIntroducedInvasiveSpecies:
      ...
      thresholdForReportingNonFatalAccidentsDaysOfAbsence:
        'Threshold for reporting non-fatal accidents (days of absence)',
