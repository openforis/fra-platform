module.exports = {
  ...
  degradedForest: {
    ...
    degradedAreaForThatYear: 'Superficie de forêt dégradée pour cette année lè (1 000 ha)',
    ...
    mainMethods: 'Principales méthodes utilisées pour le suivi des superficies de forêt dégradée',
