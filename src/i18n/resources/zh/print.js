module.exports = {
  title: 'FRA {{cycleName}}报告',
  titleTables: 'FRA {{cycleName}}报告表',
  tableOfContent: '目录',
  ...
  disclaimerGenerated: `本文件是根据粮农组织收到的、被用于撰写{{cycleName}}年全球森林资源评估报告的正式官方文件自动生成的。该官方文件中的内容和观点由文件提交单位负责。粮农组织不对本文件所载信息的任何使用负责。`,
