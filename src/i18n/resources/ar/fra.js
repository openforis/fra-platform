module.exports = {
  ...
  primaryForestByClimaticDomain: {
    ...
    totalPrimaryForest: 'المجموع الكلي',
  },
  ...
  extentOfForest_forestAreaStatusAndTrend_Description: {
    ...
    status: {
      high: 'مصادر البيانات: الجرد الوطني للغابات أو الاستشعار عن بعد (مسح قائم على العينات أو رسم الخرائط المتواصل) مع تقييم الدقة / معايرة البيانات الميدانية.',
      medium:
        'مصادر البيانات: الجرد الوطني القديم للغابات أو الاستشعار عن بعد (المسح القائم على العينات أو رسم الخرائط المتواصل) مع تقييم الدقة / معايرة البيانات الميدانية.',
      low: 'مصادر البيانات: أخرى ، مثل السجلات أو تقديرات الخبراء أو الاستشعار عن بعد دون تقييم الدقة / معايرة البيانات الميدانية.',
    },
    trend: {
      high: 'تستند التقديرات إلى التوافق المتكرر قوائم الجرد الوطنية للغابات حيث لا يتجاوز تاريخ أحدثها خمس سنوات ؛ و / أو الاستشعار عن بعد - تقييمات التغيير من خلال التحليل متعدد الأوقات لفترة لا تنتهي قبل أكثر من خمس سنوات (على سبيل المثال ، خفض الانبعاثات الناتجة عن إزالة الغابات وتدهورها (+REDD) ، المستويات المرجعية [للانبعاثات]).',
      medium:
        'تستند التقديرات إلى التوافق المتكرر قوائم الجرد الوطنية للغابات حيث يكون أحدثها قد مضي عليها اكثر من خمس سنوات ؛ و / أو تقييمات تغير الاستشعار عن بعد من خلال التحليل متعدد الأوقات لفترة تنتهي قبل أكثر من خمس سنوات ؛ أو مقارنة الخرائط المتوافقة بدون تحليل زمني متعدد.',
  ...
  growingStock_growingStockStatus_Description: {
    ...
    status: {
      high: 'تم تطبيق عوامل تحويل الكتل الحيوية والتوسع الخاصة بالبلد أو معادلات القياس التماثلية',
      medium:
        'تطبيق المعادلات التفاضلية العامة أو على مستوى المنطقة الحيوية أو مجموعة من عوامل التحويل الخاصة بالبلد / المنطقة الحيوية وعوامل توسيع الكتلة الحيوية الافتراضية للهيئة الحكومية الدولية المعنية بتغير المناخ.',
      low: 'تم تطبيق معاملات التحويل والتوسع الافتراضية للكتلة الحيوية للهيئة الحكومية الدولية المعنية بتغير المناخ (على سبيل المثال باستخدام "حاسبة الكتلة الحيوية") ، أو التقديرات المستندة إلى خرائط الكتلة الحيوية المستندة إلى الاستشعار عن بعد.',
    },
  },
}
