...
import { AssessmentActions, useCountries, useCountry, useCycle } from 'client/store/assessment'
...
const Country: React.FC = () => {
  ...
  return (
    <div className={classNames('app-view', { 'navigation-on': navigationVisible })}>
      ...
      <Routes>
        <Route path={`${ClientRoutes.Assessment.Cycle.Country.Home.Root.path.relative}/*`} element={<AssessmentHome />} />

        <Route path={`${ClientRoutes.Assessment.Cycle.Country.Print.path.relative}/*`} element={<AssessmentPrint />} />

        <Route path={ClientRoutes.Assessment.Cycle.Country.DataDownload.path.relative} element={<AssessmentDataDownload />} />
