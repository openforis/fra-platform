  ...
  return (
    <DataGrid ref={gridRef} className="explorer-result-grid" gridTemplateColumns={gridTemplateColumns}>
      ...
      {xCombinations.map((combination, idx) => {
        ...
        const measureName = measureIdx === -1 ? null : _getCombinationStringValue<MeasureName>(combination[measureIdx])
        const dimensionName =
          dimensionIdx === -1 ? null : _getCombinationStringValue<DimensionName>(combination[dimensionIdx])
        ...
        return (
          ...
          >
            <div className="result-grid__header-content">
              {renderLabel({
