...
import { GeoMosaicSlice } from 'client/store/geo/mosaic/slice'
...
export const GeoSlice = combineSlices(GeoMapSlice, GeoRecipesSlice, GeoLayersSlice, GeoMosaicSlice, GeoStatisticsSlice)
