...
export const geoSlice = createSlice({
  ...
  reducers: {
    ...
    setLayerOptions: (
      state: Draft<GeoState>,
      action: PayloadAction<{ sectionKey: LayerSectionKey; layerKey: LayerKey; options: LayerStateOptions }>
    ) => {
      const { sectionKey, layerKey, options } = action.payload
      const layerState = getLayerState(state, sectionKey, layerKey)
    ...
    setLayerSectionRecipeName: (state, action: PayloadAction<{ sectionKey: LayerSectionKey; recipe: string }>) => {
