...
export const useIsCountry = () => useIsPath({ path: `${ClientRoutes.Assessment.Cycle.Country.Landing.path.absolute}/*`, exact: false })

export const useIsAdmin = () => useIsPath({ path: `${ClientRoutes.Assessment.Cycle.Admin.Root.path.absolute}/*`, exact: false })

export const useIsLogin = () => useIsPath({ path: `${ClientRoutes.Assessment.Cycle.Login.Root.path.absolute}/*`, exact: false })

export const useIsUserEditPage = () => useIsPath({ path: `${ClientRoutes.Assessment.Cycle.Users.User.path.absolute}/*`, exact: false })
...
export const useIsGeoPage = () => useIsPath({ path: `${ClientRoutes.Assessment.Cycle.Country.Geo.path.absolute}/*`, exact: false })
