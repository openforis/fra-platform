...
export const updateTableDataDependencies = async (props: Props): Promise<void> => {
  ...
  const data: UpdateDependenciesJob['data'] = { assessment, cycle, nodeUpdates, user, isODP, includeSourceNodes }
