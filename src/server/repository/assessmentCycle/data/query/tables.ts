...
export const tables: Array<TableType> = [
  ...
  },
  {
    ...
    variableNames: {
      ...
      native_rank6: 'native_rank#6',
      native_rank7: 'native_rank#7',
      native_rank8: 'native_rank#8',
      native_rank9: 'native_rank#9',
      native_rank10: 'native_rank#10',
...
export const specialTables: Array<TableType> = [
  {
    ...
    variableNames: {
      ...
      technician_certificate_total: '7b_tec_tot',
      technician_certificate_female: '7b_tec_fem',
      technician_certificate_male: '7b_tec_male',
