...
export const tables: Tables = {
  ...
  extentOfForest: { variables: ['forestArea', 'totalLandArea'], columns: ['1990', '2000', '2010', '2020'] },
  ...
  forestOwnership: { variables: ['other_or_unknown', 'private_ownership', 'public_ownership'], columns: ['2015'] },
  growingStockTotal: { variables: ['growing_stock_total'], columns: ['1990', '2000', '2010', '2020'] },
  ...
  specificForestCategories: { variables: ['primary_forest'], columns: ['2020'] },
}
