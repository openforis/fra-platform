...
import { isStatusSaving } from '../../../app/components/autosave/autosave'
import Icon from '../../../components/icon'
import useI18n from '../../../hooks/useI18n'
import { getFilesList, uploadFile, deleteFile } from '../../../app/countryLanding/actions'
...
const LinksView = () => {
  ...
  const status = useAppSelector((state) => state.autosave?.status)
