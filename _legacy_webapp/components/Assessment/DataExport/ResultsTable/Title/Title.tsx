...
import { SectionSpecs, Unit, UnitFactors } from '../../../../../sectionSpec'
import { useAssessmentType } from '../../../../../store/app'
import { useDataExportSelection } from '../../../../../store/page/dataExport'
import { useI18n, useParamSection } from '../../../../../hooks'
import { getUnitLabelKey, getVariableLabelKey } from '../../../../../components/Assessment/DataExport/utils'
