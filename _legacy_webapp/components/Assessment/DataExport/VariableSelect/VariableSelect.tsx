...
import { SectionSpecs } from '../../../../sectionSpec'
import { useAssessmentType } from '../../../../store/app'
import { DataExportActions, DataExportSelection, useDataExportSelection } from '../../../../store/page/dataExport'
import { useI18n, useParamSection } from '../../../../hooks'
import { getVariableLabelKey } from '../../../../components/Assessment/DataExport/utils'
