...
const tableSpec = SectionSpec.newTableSpec({
  ...
  [SectionSpec.KEYS_TABLE.columnsExport]: ['undisturbed_by_man'],
  [SectionSpec.KEYS_TABLE.columnsExport]: ['semi_natural'],
  [SectionSpec.KEYS_TABLE.columnsExport]: ['plantations'],
