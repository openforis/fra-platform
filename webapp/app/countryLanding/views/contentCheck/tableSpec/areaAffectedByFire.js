/*
 * TODO: Used in content check view
 * */
  ...
  return {
      ...
      <thead>
        <tr>
          <th className="fra-table__header-cell-left" rowSpan="2">
            {i18n.t('areaAffectedByFire.categoryHeader')}
          </th>
          <th className="fra-table__header-cell" colSpan={years.length}>
            {i18n.t('areaAffectedByFire.areaUnitLabel')}
          </th>
        </tr>
        <tr>
          {R.map(
            (year) => (
              <th key={year} className="fra-table__header-cell">
                {year}
              </th>
            ),
            years
    ...
    rows: [
      [
        {
          type: 'readOnly',
          jsx: <th className="fra-table__category-cell">{i18n.t('areaAffectedByFire.totalLandAreaAffectedByFire')}</th>,
        },
        ...integerInputColumns,
      ],
      [
