    ...
    datasets: [
      {
        ...
        borderColor: [ChartUtils.colors.darkPurple, ChartUtils.colors.darkOrange, ChartUtils.colors.darkGreen],
        ...
        hoverBorderColor: [
          ChartUtils.colors.darkPurpleHover,
          ChartUtils.colors.darkOrangeHover,
          ChartUtils.colors.darkGreenHover,
        ],
      },
    ],
