...
const downloadPath = (countryIso, selectedDomain, language) => `/api/biomassStock/${countryIso}/${selectedDomain}/${language}/download`
...
const ExcelCalculatorDownload = () => {
  ...
  const calculatorFilePath = downloadPath(countryIso, selectedDomain, i18n.language)
