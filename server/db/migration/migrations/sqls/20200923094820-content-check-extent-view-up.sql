...
SELECT sfc.country_iso
     ...
     , (sfc."2015" / NULLIF(eof."2016", 0) * 100)::NUMERIC(100, 2) AS "2016"
     , (sfc."2015" / NULLIF(eof."2017", 0) * 100)::NUMERIC(100, 2) AS "2017"
     , (sfc."2015" / NULLIF(eof."2018", 0) * 100)::NUMERIC(100, 2) AS "2018"
     , (sfc."2015" / NULLIF(eof."2019", 0) * 100)::NUMERIC(100, 2) AS "2019"
...
SELECT fawpa.country_iso
    ...
    END                                                              AS row_name
     ...
     , (fawpa."2015" / NULLIF(eof."2016", 0) * 100)::NUMERIC(100, 2) AS "2016"
     , (fawpa."2015" / NULLIF(eof."2017", 0) * 100)::NUMERIC(100, 2) AS "2017"
     , (fawpa."2015" / NULLIF(eof."2018", 0) * 100)::NUMERIC(100, 2) AS "2018"
     , (fawpa."2015" / NULLIF(eof."2019", 0) * 100)::NUMERIC(100, 2) AS "2019"
