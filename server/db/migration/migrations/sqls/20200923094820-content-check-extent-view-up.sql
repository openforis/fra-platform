...
SELECT sfc.country_iso
     ...
     , (sfc."2016" / NULLIF(eof."2016", 0) * 100)::NUMERIC(100, 2) AS "2016"
     , (sfc."2017" / NULLIF(eof."2017", 0) * 100)::NUMERIC(100, 2) AS "2017"
     , (sfc."2018" / NULLIF(eof."2018", 0) * 100)::NUMERIC(100, 2) AS "2018"
     , (sfc."2019" / NULLIF(eof."2019", 0) * 100)::NUMERIC(100, 2) AS "2019"
