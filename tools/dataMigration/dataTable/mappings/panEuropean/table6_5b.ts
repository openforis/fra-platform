export default {
  tableName: 'table_6_5b',
  schemaName: 'pan_european',
  section: 'panEuropean_6_5_b',
  rows: {
    names: [
      'forestry_2015',
      'forestry_2010',
  ...
  columns: [
    { name: 'education_0_2', type: 'numeric' },
    { name: 'education_3_4', type: 'numeric' },
    { name: 'education_5_6', type: 'numeric' },
    { name: 'employees', type: 'numeric' },
    { name: 'self_employed', type: 'numeric' },
  ],
}
