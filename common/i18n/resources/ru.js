...
{{- serverUrl}}`,
  ...
  panEuropean: {
    ...
    landing: {
      link: 'Совместный отчет FOREST EUROPE / UNECE / FAO по общеевропейским показателям SFM : FOREST EUROPE',
    },
    home: {
      description1:
        'Этот набор данных состоит из информации, предоставленной корреспондентами из европейских стран, которые заполнили совместный опросник FOREST EUROPE, UNECE, FAO по общеевропейским количественным индикаторам для устойчивого управления лесами.',
      description2:
        'Примечание: Общеевропейский отчет 2020 был выполнен параллельно с FRA 2020, тем не менее, хотя они содержат различные вычисления, некоторые переменные появляются в обоих отчетах. В вычислениях State of Europe’s Forest (SoEF) 2020 по части информации были проведены дальнейшие консультации с корреспондентами из европейских стран, и эта информация может отличаться от представленной во FRA Platform.',
    },
    ...
    ageClassDistributionVolumeOfEvenAgedStandsInForestAvailableForWoodSupply: {
      ...
      categoryYear: 'Категория - Год',
      developmentPhases1000ha: 'Фазы развития (1 000 м³)',
      total_volume: 'Общий объем (1 000 м³)',
      regeneration_phase: 'Фаза восстановления',
      intermediate_phase: 'Промежуточная фаза',
      mature_phase: 'Фаза зрелости',
      unspecified: 'Неопределено',
    ...
    diameterDistributionAndTotalAreaUnevenAgedStands: {
      ...
      categoryYear: 'Категория - Год',
      volumeByDiameterClasses1000mob: 'Объем по классам диаметра (1 000 м³ с корой)',
      area: 'Площадь (1 000 га)',
      total_volume: 'Общий объем (1 000 м³ с корой)',
      less_or_equal_20_cm: '<20 см',
      _21_40_cm: '21-40 см',
      _41_60_cm: '41-60 см',
      greater_60_cm: '>60 см',
    ...
    carbonStock: {
      carbonStock: 'Запас углерода',
      categoryYear: 'Категория - Год',
      carbonInAboveGroundAndBelowGroundLivingBiomass: 'Углерод живой фитомассы',
      carbonInDeadwoodAndLitter: 'Углерод мертвой фитомассы',
      millionMetricTonnes: 'Миллион метрических тонн',
      above_ground: 'Надземная',
      below_ground: 'Подземная',
      deadwood: 'Мертвая древесина',
      litter: 'Лесной опад',
    ...
    carbonStockInHarvestedWoodProductsHWP: {
      ...
      categoryYear: 'Категория - Год',
      total_carbon_stock_in_hwp: 'Всего запас углерода в товарах из заготовленной древесины (миллион метрических тонн)',
    ...
    forestAreaWithDamage: {
      ...
      insects_and_disease: 'Насекомые и болезни',
    ...
    areaWithForestLandDegradation: {
      ...
      other_wooded_land: 'Прочая лесопокрытая земля - {{year}}',
      total_forest_and_other_wooded_land: 'Всего лес и прочая лесопокрытая земля - {{year}}',
      otherNames: 'Названия других факторов, вызвавших деградацию земли',
    },
    ...
    incrementAndFellings: {
      ...
      fellings_total: 'Всего',
      _of_which_of_natural_losses: '… в т. ч: естественные потери',
      forest: 'Лес - {{year}}',
      _of_which_forest_available_for_wood_supply: '... в т. ч: лес доступный для поставки древесины - {{year}}',
    },
    ...
    annualForestExpansionAndRegeneration: {
      ...
      afforestation: 'Лесоразведение',
      natural_expansion: 'Естественное расширение',
      natural_regeneration: 'Естественное восстановление',
      planting_and_seeding: 'Посадка насаждений и посев семян',
      coppice: 'Порослевое возобновление',
      forest: 'Лес - {{year}}',
    },
    ...
    naturalnessBySubclasses: {
      ...
      plantations: 'Плантации',
      naturally_established: 'Естественно образовавшаяся',
      naturalised_introduced_species: 'Натурализованные интродуцированные виды',
      established_by_planting_and_or_seeding: 'Образовавшаяся путем посадки саженцев и/или посева',
      coppice: 'Роща',
      unknown_origin: 'Неизвестного происхождения',
      native_species: 'Местные виды',
      introduced_species: 'Интродуцированные виды',
      forest: 'Лес - {{year}}',
    },

    // table4.4a
    introducedTreeSpecies: {
      introducedTreeSpecies: 'Интродуцированные виды деревьев',
      categoryYear: 'Категория - Год',
    ...
    forestHoldings: {
      ...
      less_10_ha_area: 'Площадь (1000 га)',
      less_10_ha_number: 'Кол-во лесовладений',
      _11_500_ha_area: 'Площадь (1000 га)',
      _11_500_ha_number: 'Кол-во лесовладений',
      more_500_ha_area: 'Площадь (1000 га)',
      more_500_ha_number: 'Кол-во лесовладений',
    ...
    tradeInWood: {
      ...
      _2016: '2016',
      _2017: '2017',
      exports_of_forest_products_quantity: 'Экспорт древесных продуктов (миллион m³ эквивалента круглого леса)',
      exports_of_forest_products_value: 'Экспорт древесных продуктов (миллион евро/ЭКЮ)',
      imports_of_forest_products_quantity: 'Импорт древесных продуктов (миллион m³ эквивалента круглого леса)',
    ...
    totalEnergySupplyFromWood: {
      ...
      category: 'Категория',
      tj: 'ТДж',
      _1000MetricTonnesDryMatter: '1000 метрических тонн сухого вещества',
