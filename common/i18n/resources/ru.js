module.exports.translation = {
  ...
  user: {
    roles: {
      ...
      alternateNationalCorrespondent: 'Национальный корреспондент',
      alternateNationalCorrespondent_0: 'Национальный корреспондент',
      alternateNationalCorrespondent_1: 'Национальных корреспондента',
      alternateNationalCorrespondent_2: 'Национальных корреспондентов',
