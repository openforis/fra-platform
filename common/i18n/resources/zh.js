...
module.exports.translation = {
  ...
  unit: {
    ...
    millionTonnes: '百万公吨',
    millionsCubicMeterOverBark: 'million m³ 百万立方米（带皮）',
...
{{- url}}
  ...
  fraForestCharacteristicsClass: {
    naturallyRegeneratingForest: '天然林',
...
{{- url}}
  ...
  specificForestCategories: {
    ...
    primaryForest: '原始林',
    exceedsNaturallyRegeneratingForest: '超过天然林(1b)',
    rubberWood: '橡胶木',
  },
  ...
  holderOfManagementRights: {
    holderOfManagementRights: '国有森林管理权人',
    categoryHeader: 'FRA类别',
    areaUnitLabel: '森林面积(1000公顷)',
  ...
  degradedForest: {
    degradedForest: '已退化的森林',
    doesYourCountryMonitor: '贵国监测已退化森林的面积吗？',
    ifYes: '如果 "是"',
    whatIsDefinition: '贵国是如何界定“已退化的森林”的？',
  ...
  nonWoodForestProductsRemovals: {
    nonWoodForestProductsRemovals: '2015年非木质林产品采集量及价值',
    nameOfProduct: '非木质林产品名称',
    keySpecies: '关键种类',
    quantity: '数量',
    unit: '单位',
    value: '价值 (1000当地货币)',
  ...
  sustainableDevelopment: {
    ...
    sdgIndicator1: '可持续发展目标指标 15.1.1 2015年森林面积占陆地总面积的比例',
    sdgIndicator2: '可持续发展目标指标15.2.1 实施可持续森林管理取得的进展',
    forestAreaProportionLandArea2015: '2015年森林面积占陆地总面积的比例',
    subIndicator: '细化指标 {{no}}',
    forestAreaAnnualNetChangeRate: '森林面积年度净变化率',
    aboveGroundBiomassStockForests: '森林地上生物量',
    percent2015ForestAreaBaseline: '百分比 (2015年森林面积作为基准)',
...
{{- serverUrl}}`,
  ...
  fraReportPrint: {
    ...
    tableOfContent: '目录',
    disclaimer: `自1946年以来，粮农组织每隔5至10年对世界森林进行一次监测。全球森林资源评估（FRA）报告现在每五年编制一次，目的是提供一种连贯一致的方法来描述世界森林及其变化情况。FRA是一项国家驱动的进程，评估基于官方指定的国家通讯员编写的报告。 如果没有报告，则由FRA秘书处根据以往报告、现有信息和/或基于遥感的分析进行案头分析。`,
  ...
  panEuropean: {
    ...
    areaWithForestLandDegradation: {
      areaWithForestLandDegradation: '已退化森林的面积',
      categoryYear: '类别-年份',
      totalAreaOfDegradedLand: '已退化土地的总面积',
      areaPrimarilyDegradedBy: '退化面积（按导致退化的主要因素）',
      formerDegradedLandRestored: '得到恢复的已退化森林',
      grazing: '放牧',
      repeatedFires: '反复的火灾',
      airPollution: '空气污染',
      desertification: '荒漠化',
      ...
      total_area_of_degraded_land: '已退化土地总面积',
      repeated_fires: '反复的火灾',
      air_pollution: '空气污染',
      other_1: '其他1',
      other_2: '其他2',
      other_3: '其他3',
      former_degraded_land_restored: '得到恢复已退化森林',
    },
    ...
    // table 3.3
    nonWoodGoods2015: {
      nonWoodGoods2015: '非木质产品(2015)',
      rankValue: '排名(价值)',
      nameOfGroupsOfProduct: '产品（组）名称',
      keySpecies: '主要种类',
      totalHarvestedNonWoodGoods: '已收获非木质产品总和',
      unit: '单位',
      quantity: '数量',
      marketValue1000NationalCurrency: '市场价值 (1000当地货币)',
      ...
      key_species: '关键种类',
      total_harvested_non_wood_goods_unit: '已收获非木质产品总和: 单位',
      total_harvested_non_wood_goods_quantity: '已收获非木质产品总和：数量',
      market_value_1000_national_currency: '市场价值 (1000国家货币)',
      nwfp_category: '非木质林产品类别',
    },
