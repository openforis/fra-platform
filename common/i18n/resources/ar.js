...
{{- serverUrl}}`,
  ...
  fraReportPrint: {
    title: 'تقرير تقييم الموارد الحرجية لعام 2020',
    titleTables: 'جداول حول التقرير الخاص بتقييم الموارد الحرجية لعام 2020',
    tableOfContent: 'قائمة المحتويات',
    disclaimer: `        'ترصد منظمة الأغذية والزراعة الغابات في العالم منذ عام 1946 بفاصل زمني من خمس إلى 10 سنوات. واليوم تصدر تقييمات الموارد الحرجية العالمية كل خمس سنوات بهدف توفير نهج متسق يقدم من خلاله توصيفاً للغابات في العالم والتغيرات التي تطرأ عليها. وتقييم الموارد الحرجية عملية قطرية تعتمد فيها التقييمات على تقارير يُعدها مراسلون وطنيون تتسم تسميتهم رسمياً. وفي حال عدم توافر تقرير ما، تقوم أمانة تقييم الموارد الحرجية بإعداد دراسة مكتبية يتم الاعتماد فيها على تقارير سابقة وكذلك على المعلومات المتوافرة أو تحليل قائم على الاستشعار عن بعد أو جميعها معاً. `,
    disclaimerGenerated: `أعدت هذه الوثيقة تلقائياً باستخدام التقرير الذي أعد للإسهام في التقييم الذي أجرته منظمة الأغذية والزراعة للموارد الحرجية العالمية لعام 2020، حيث قـُدمت إلى المنظمة كوثيقة حكومية رسمية. أما محتوى هذا التقرير والآراء الواردة فيه فتقع ضمن مسؤولية الجهة التي بعثت بالتقرير إلى منظمة الأغذية والزراعة، حيث لا تتحمل منظمة الأغذية والزراعة المسؤولية بشأن أي استخدام للمعلومات الواردة في هذه الوثيقة.`,
    disclaimerGeneratedDeskStudy: `أعدت هذه الوثيقة تلقائياً من خلال دراسة مكتبية. ولا تتحمل منظمة الأغذية والزراعة المسؤولية بشأن أي استخدام للمعلومات الواردة في هذه الوثيقة.`,
  },
  ...
  panEuropean: {
    ...
    totalEnergySupplyFromWood: {
      ...
      _2007_tj: '2007: تيراجول',
      _2009_tj: '2009: تيراجول',
      _2011_tj: '2011: تيراجول',
      _2013_tj: '2013: تيراجول',
      _2015_tj: '2015: تيراجول',
      _2007__1000MetricTonnesDryMatter: '2007: 1000 طن متري مادة جافة',
      _2009__1000MetricTonnesDryMatter: '2009: 1000 طن متري مادة جافة',
      _2011__1000MetricTonnesDryMatter: '2011: 1000 طن متري مادة جافة',
      _2013__1000MetricTonnesDryMatter: '2013: 1000 طن متري مادة جافة',
      _2015__1000MetricTonnesDryMatter: '2015: 1000 طن متري مادة جافة',
    },
